...
Project.unit<1>.dataChannel<0>=stateNum_dtransfer_0_G
Project.unit<1>.dataChannel<1>=stateNum_dtransfer_0_D
Project.unit<1>.dataChannel<2>=Udc_data samples_valid
...
Project.unit<1>.triggerChannel<0><0>=stateNum_dtransfer<0>
Project.unit<1>.triggerChannel<0><1>=stateNum_dtransfer<1>
