...
Project.unit<0>.dataChannel<2>=sample_counter<0>
...
Project.unit<0>.triggerChannel<1><0>=TARGETX_control SIN
...
Project.unit<1>.dataChannel<0>=Udc_data BUS_DO<0>
...
Project.unit<1>.triggerChannel<0><0>=Udc_data BUS_DO<0>
