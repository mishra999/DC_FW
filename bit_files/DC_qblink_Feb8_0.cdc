...
Project.unit<0>.dataChannel<8>=stateNum_dtransfer<0>
Project.unit<0>.dataChannel<9>=stateNum_dtransfer<1>
...
Project.unit<0>.triggerChannel<1><0>=stateNum_dtransfer<0>
Project.unit<0>.triggerChannel<1><1>=stateNum_dtransfer<1>
