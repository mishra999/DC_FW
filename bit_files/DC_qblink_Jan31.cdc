...
Project.unit<1>.clockChannel=clk_buffer clkout2
Project.unit<1>.clockEdge=Rising
Project.unit<1>.dataChannel<0>=Udc_data DigitizeAndShiftOutData_i ShftWin_i U0 sample_data_0<0>
Project.unit<1>.dataChannel<10>=Udc_data DigitizeAndShiftOutData_i ShftWin_i U0 sample_data_0<10>
Project.unit<1>.dataChannel<11>=Udc_data DigitizeAndShiftOutData_i ShftWin_i U0 sample_data_0<11>
Project.unit<1>.dataChannel<12>=Udc_data BUS_DO<0>
Project.unit<1>.dataChannel<1>=Udc_data DigitizeAndShiftOutData_i ShftWin_i U0 sample_data_0<1>
Project.unit<1>.dataChannel<2>=Udc_data DigitizeAndShiftOutData_i ShftWin_i U0 sample_data_0<2>
Project.unit<1>.dataChannel<3>=Udc_data DigitizeAndShiftOutData_i ShftWin_i U0 sample_data_0<3>
Project.unit<1>.dataChannel<4>=Udc_data DigitizeAndShiftOutData_i ShftWin_i U0 sample_data_0<4>
Project.unit<1>.dataChannel<5>=Udc_data DigitizeAndShiftOutData_i ShftWin_i U0 sample_data_0<5>
Project.unit<1>.dataChannel<6>=Udc_data DigitizeAndShiftOutData_i ShftWin_i U0 sample_data_0<6>
Project.unit<1>.dataChannel<7>=Udc_data DigitizeAndShiftOutData_i ShftWin_i U0 sample_data_0<7>
Project.unit<1>.dataChannel<8>=Udc_data DigitizeAndShiftOutData_i ShftWin_i U0 sample_data_0<8>
Project.unit<1>.dataChannel<9>=Udc_data DigitizeAndShiftOutData_i ShftWin_i U0 sample_data_0<9>
...
Project.unit<1>.triggerChannel<0><0>=Udc_data DigitizeAndShiftOutData_i ShftWin_i U0 sample_data_0<0>
Project.unit<1>.triggerChannel<0><10>=Udc_data DigitizeAndShiftOutData_i ShftWin_i U0 sample_data_0<10>
Project.unit<1>.triggerChannel<0><11>=Udc_data DigitizeAndShiftOutData_i ShftWin_i U0 sample_data_0<11>
Project.unit<1>.triggerChannel<0><1>=Udc_data DigitizeAndShiftOutData_i ShftWin_i U0 sample_data_0<1>
Project.unit<1>.triggerChannel<0><2>=Udc_data DigitizeAndShiftOutData_i ShftWin_i U0 sample_data_0<2>
Project.unit<1>.triggerChannel<0><3>=Udc_data DigitizeAndShiftOutData_i ShftWin_i U0 sample_data_0<3>
Project.unit<1>.triggerChannel<0><4>=Udc_data DigitizeAndShiftOutData_i ShftWin_i U0 sample_data_0<4>
Project.unit<1>.triggerChannel<0><5>=Udc_data DigitizeAndShiftOutData_i ShftWin_i U0 sample_data_0<5>
Project.unit<1>.triggerChannel<0><6>=Udc_data DigitizeAndShiftOutData_i ShftWin_i U0 sample_data_0<6>
Project.unit<1>.triggerChannel<0><7>=Udc_data DigitizeAndShiftOutData_i ShftWin_i U0 sample_data_0<7>
Project.unit<1>.triggerChannel<0><8>=Udc_data DigitizeAndShiftOutData_i ShftWin_i U0 sample_data_0<8>
Project.unit<1>.triggerChannel<0><9>=Udc_data DigitizeAndShiftOutData_i ShftWin_i U0 sample_data_0<9>
Project.unit<1>.triggerChannel<1><0>=Udc_data BUS_DO<0>
