...
xst -ifn xst.scr
move clk_gen1_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\clk_gen1_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clk_gen1_exdes.ucf clk_gen1_exdes

echo 'Running map'
map -timing -pr b clk_gen1_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm clk_gen1_exdes -w routed.ncd routed.vhd
cd ..
